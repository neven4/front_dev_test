...

                    {
                      products.map((product, i) => {
                        return <Product key={i}
                          ...
                          title={product.title}
                          assoc={product.assocProducts.split(';')}
                          unit={product.unit}
                          unitAlt={product.unitAlt}
                          unitRatio={+product.unitRatio.toFixed(2)}
                          unitRatioAlt={+product.unitRatioAlt.toFixed(2)}
                          priceRetail={+product.priceRetail.toFixed(2)}
                          priceRetailAlt={+product.priceRetailAlt.toFixed(2)}
                          priceGold={+product.priceGold.toFixed(2)}
                          priceGoldAlt={+product.priceGoldAlt.toFixed(2)}
                        />
                      })
                    }
